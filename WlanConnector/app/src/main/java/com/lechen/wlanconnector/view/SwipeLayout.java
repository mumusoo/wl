...
//			if(distance>0&&frontView.getLeft()>-range*0.4f){
//				close();
//			}else if(distance<0&&frontView.getLeft()<-range*0.2f){
//				open();
//			}else if(distance>0&&frontView.getLeft()>-range*0.2f){
//				close();
//			}else{
//				open();
//			}
			if(distance>30&&frontView.getLeft()<0){
				close();
			}else if(distance<-30&&frontView.getLeft()<0){
				open();
			}else if(getStatus().equals(Status.CLOSE)){
				close();
			}else{
				open();
			}
...
//				open();
//			}
//			if(xvel==0&&frontView.getLeft()>-range*0.5f&&frontView.getLeft()<0){
//				close();
//			}
